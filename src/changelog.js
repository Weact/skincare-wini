...
export const CHANGELOG = [
  {
    ...
    entries: [
      ...
      'Every note has an In field sitting right beside its title: open a note, tap Edit, and pick the project, category or Unfiled it should live in — no dragging needed. The same field is on the add form, so a new note can be filed somewhere other than the section you started from',
      ...
      'Give any project or category a colour — eight to pick from, plus Default — and its header band takes it. A category keeps its own colour inside a coloured project, so the tiers stay tellable apart at a glance. The colour is on the new-project and new-category forms too, and every shade has a light and a dark version',
