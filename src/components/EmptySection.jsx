...
// A virtual, computed grouping — like Expired, not a real category, so it
// can't be reordered into and needs no rename/delete menu or drag handle.
// Unlike Expired though, membership isn't date-derived: it only reflects
// products the user explicitly marked as empty (see ProductCard's "Mark as
// empty" action, which sets product.emptiedAt).
export default function EmptySection({
  ...
  return (
    <div className="cat-section cat-section--empty">
      <div className="cat-header">
        <button className="cat-header-main" onClick={() => setCollapsed(c => !c)}>
          <span className="cat-emoji">🫙</span>
          <span className="cat-name">Empty</span>
